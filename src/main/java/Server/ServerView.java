...
//    public static Queue<PedidoClass> colaDelivery = new LinkedList<>(); //Pendientes del delivery
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtTiempo, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (PedidoClass p : todosLosPedidos) {
            if(txtDPI.getText().equals(p.getId())){
                modelo.addRow(new Object[]{p.getId(), p.getCliente(), p.getTipo(), "Q" + p.getTotalPedido()});
            }
        }

        long fin = System.nanoTime(); // Parar temporizador
        long tiempoMs = (fin - inicio); // Convertir a milisegundos
        txtTiempo.setText("Tiempo: " + tiempoMs + " ns");
